...
if (!function_exists('ks_print_shared_contact_button')) {
  function ks_print_shared_contact_button() {
    ?>
    <a
      class="ks-btn ks-btn--dark ks-contact-section__button"
      href="mailto:fussballschule@selcuk-kocyigit.de"
      data-i18n="common.contact.button"
    >
...
if (!function_exists('ks_get_shared_contact_rows')) {
  function ks_get_shared_contact_rows($theme_uri) {
    return [
      ks_get_shared_contact_row(
        'tel:+4917643203362',
        'phone.png',
        'common.contact.phoneTitle',
        'Ruf uns an:',
        '',
        '+49 (176) 43 20 33 62',
        'common.contact.phoneAria',
        'Anrufen',
        $theme_uri
      ),
      ks_get_shared_contact_row(
        'mailto:fussballschule@selcuk-kocyigit.de',
        'mail.png',
        'common.contact.mailTitle',
        'Schreib uns:',
        '',
        'fussballschule@selcuk-kocyigit.de',
        'common.contact.mailAria',
        'E-Mail schreiben',
        $theme_uri
      ),
      ks_get_shared_contact_row(
        '',
        'clock.png',
        'common.contact.hoursTitle',
        'Telefonzeiten:',
        'common.contact.hoursText',
        'Mo.–Fr. 09:00–20:00 Uhr',
        'common.contact.hoursAria',
