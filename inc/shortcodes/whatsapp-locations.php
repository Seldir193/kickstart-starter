      ...
      if ($mode === 'single') {
        ...
        >
          <div class="container ks-wa-grid">
            ...
            <a
              class="<?php echo esc_attr($a['btn_class']); ?>"
      ...
      >
        <div class="container ks-wa-inner">
          ...
          <form
            ...
            data-wa-campaign="<?php echo esc_attr($a['campaign']); ?>"
            onsubmit="return false;"
          >
            <label
              for="<?php echo esc_attr($uid); ?>_select"
            ...
            >
              ...
              <div
                class="ks-dd__panel"
                id="<?php echo esc_attr($uid); ?>_panel"
                role="listbox"
                tabindex="-1"
                hidden
              >
